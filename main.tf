...
resource "azurerm_service_plan" "product_service_plan" {
  name     = "asp-product-service-sand-ne-csr"
  location = "northeurope"
...
resource "azurerm_application_insights" "products_service_fa" {
  name             = "appins-fa-products-service-sand-ne-csr"
...
resource "azurerm_windows_function_app" "products_service" {
  ...
  site_config {
    ...
    cors {
      allowed_origins = ["https://portal.azure.com", "https://stgsangproductsfanecsr.z16.web.core.windows.net"]
    }
